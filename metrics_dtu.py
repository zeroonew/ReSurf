...
def custom_sort(file_name):
    # Rendered filenames may be plain numbers (e.g. "0000.png") or prefixed
    # (e.g. "ours_0000.png"); extract the leading integer for sorting.
    import re
    m = re.search(r'(\d+)', os.path.splitext(file_name)[0])
