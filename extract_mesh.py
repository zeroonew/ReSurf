    ...
    # if False:
        ...
        for idx, view in enumerate(tqdm(views, desc="TSDF Fusion progress")):
            ...
            if view.gt_alpha_mask is not None:
                ref_depth[view.gt_alpha_mask.squeeze() < 1.0] = 0
...
def render_sets(dataset : ModelParams, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool,
                 max_depth : float, voxel_size : float, sdf_trunc_mul : float, num_cluster: int, use_depth_filter : bool):
    with torch.no_grad():
        ...
        volume = o3d.pipelines.integration.ScalableTSDFVolume(
            ...
            sdf_trunc=sdf_trunc_mul * voxel_size,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sdf_trunc_mul", default=2.0, type=float)
    parser.add_argument("--num_cluster", default=20, type=int)
    ...
    render_sets(model.extract(args), args.iteration, pipeline.extract(args), args.skip_train, args.skip_test, args.max_depth, args.voxel_size, args.sdf_trunc_mul, args.num_cluster, args.use_depth_filter)
