...
if __name__ == '__main__':
    ...
    stl_path = f'{args.dataset_dir}/Points/stl/stl{args.scan:03}_total.ply'
    if not os.path.exists(stl_path):
        # Fallback: go up to project root and look in data/Points/stl/
        stl_path = os.path.join(os.path.dirname(os.path.dirname(args.dataset_dir)), 'Points', 'stl', f'stl{args.scan:03}_total.ply')
    stl_pcd = o3d.io.read_point_cloud(stl_path)
