...
def post_process_mesh(mesh, cluster_to_keep=1000):
    ...
    """
    import copy
    print(f"Post-processing mesh with up to {cluster_to_keep} connected components.")
    ...
    print(f"Vertices before post-process: {len(mesh.vertices)}")
    print(f"Vertices after post-process: {len(mesh_0.vertices)}")
    return mesh_0
